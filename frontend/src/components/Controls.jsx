        ...
        <div className="controls glass">
            ...
            <div className="control-section">
                <div className="action-buttons">
                    <button className="action-btn new-game-btn" onClick={onNewGame} title={isMultiplayer ? 'Leave Multiplayer Match' : 'New Game'}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <path d="M23 4v6h-6" /><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10" />
                        </svg>
                        {isMultiplayer ? 'Leave Match' : 'New Game'}
                    </button>

                    <button className="action-btn" onClick={onUndo} title="Undo Move" disabled={isThinking || isMultiplayer}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <button className="action-btn hint-btn" onClick={onHint} title="Get Hint" disabled={isMultiplayer || isThinking || hintLoading || sideToMove !== 'white' || gameStatus !== 'ongoing'}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <path d="M9 18h6" />
                            <path d="M10 22h4" />
                    ...
                    <button className="action-btn" onClick={onFlip} title="Flip Board" disabled={isMultiplayer}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="control-section">
                ...
                <div className="hint-output">
                    {isMultiplayer
                      ? 'Hints are disabled in multiplayer mode.'
                      : hintMove
                        ? `Suggested move: ${hintMove}`
                        : 'Request a hint to see the best move.'}
                </div>
            </div>
        </div>
    );
